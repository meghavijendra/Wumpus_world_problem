...
def tt_verification(knowledge_base, statement, symbols, model):
    if not symbols:
        ...
        check_total = tt_verification(knowledge_base, statement, symbols,
                                      link_msv(model, symbols_pop, True)) and tt_verification(knowledge_base, statement,
                                                                                              symbols, link_msv(model,
                                                                                                                symbols_pop,
                                                                                                                False))
        # print(check_total)
        return check_total
